...
> ## Tip: 
> Make sure there are no spaces before or after your URL, or your web browser may interpret it as a search query.
{: .callout}
...
- **Environment/History**: Here, RStudio will show you what datasets and
  ...
  and dimensions. The "History" tab contains a history of the R commands you've executed.
...
advantage of RStudio's Tab-autocompletion method, to select the `home`, `dcuser`,
...
> ## Tip: Never use `setwd()`
>
> Wait, what was the last 2 minutes about? Well, although setting your working directory
> is something you need to do, you need to be very careful about using this as
> a step in your script. For example, what if your script is being run on a computer
...
You can also see a function's argument(s) using the `args()` function:
